! function () {
    ...
    let i, t, n, a, o, r = [].indexOf || function (t) {
    ...
    h.prototype.extend = function (t, e) {
        ...
        for (let e, n = this.keys, i = e = 0, o = n.length; e < o; i = ++e)
            if (n[i] === t) return this.values[i]
    }, u.prototype.set = function (t, e) {
        for (let n, i = this.keys, o = n = 0, s = i.length; n < s; o = ++n)
        ...
        if (this.stopped = !1, this.boxes = function () {
                for (let t = this.element.querySelectorAll("." + this.config.boxClass), e = [], n = 0, i = t.length; n < i; n++) o = t[n], e.push(o);
                return e
            }.call(this), this.all = function () {
                for (let t = this.boxes, e = [], n = 0, i = t.length; n < i; n++) o = t[n], e.push(o);
                return e
        ...
        return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new i((r = this, function (t) {
            for (let o, s, e = [], n = 0, i = t.length; n < i; n++) s = t[n], e.push(function () {
                for (let t = s.addedNodes || [], e = [], n = 0, i = t.length; n < i; n++) o = t[n], e.push(this.doSync(o));
                return e
            }.call(r));
            return e
        ...
        let n, i = t.getAttribute("data-wow-duration"),
        ...
        for (let t, e = this.boxes, n = [], i = 0, o = e.length; i < o; i++) t = e[i], n.push(t.style.visibility = "visible");
        return n
        ...
        for (s in t) r = t[s], o["" + s] = r, e.push(function () {
            for (let t = this.vendors, e = [], n = 0, i = t.length; n < i; n++) l = t[n], e.push(o["" + l + s.charAt(0).toUpperCase() + s.substr(1)] = r);
            return e
        }.call(this));
        return e
    }, s.prototype.vendorCSS = function (t, e) {
        for (let n, i = a(t), o = i.getPropertyCSSValue(e), s = this.vendors, r = 0, l = s.length; r < l; r++) n = s[r], o = o || i.getPropertyCSSValue("-" + n + "-" + e);
        return o
        ...
        return !this.scrolled || (this.scrolled = !1, this.boxes = function () {
            for (let t = this.boxes, e = [], n = 0, i = t.length; n < i; n++)(o = t[n]) && (this.isVisible(o) ? this.show(o) : e.push(o));
            return e
        }.call(this), this.boxes.length || this.config.live) ? void 0 : this.stop()
    }, s.prototype.offsetTop = function (t) {
        for (let e; void 0 === t.offsetTop;) t = t.parentNode;
        for (e = t.offsetTop; t = t.offsetParent;) e += t.offsetTop;
        return e
    }, s.prototype.isVisible = function (t) {
        let e = t.getAttribute("data-wow-offset") || this.config.offset,

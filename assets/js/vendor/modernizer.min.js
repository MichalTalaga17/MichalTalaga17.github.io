! function (i, f, d) {
    ...
    function l(e, t) {
        if ("object" == typeof e)
            for (let n in e) S(e, n) && l(n, e[n]);
        else {
            let o = (e = e.toLowerCase()).split("."),
                r = g[o[0]];
    ...
    function c(e, t, n, o) {
        ...
        for (let s, a, l, u, f, c = ["modernizr", "tspan", "samp"]; !B.style && c.length;) s = !0, B.modElem = p(c.shift()), B.style = B.modElem.style;
    ...
    let _, T = (_ = !("onblur" in f.documentElement), function (e, t) {
        let n;
    ...
    let P = e._config.usePrefixes ? t.split(" ") : [];
    e._cssomPrefixes = P;
    let k = {
        elem: p("modernizr")
    };
    ...
    g.addTest("websockets", z), g.addTest("cssanimations", A("animationName", "a", !0)),
        function () {
            ...
            for (let e, t, n = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], o = 0; o < n.length; o++) e = n[o].toLowerCase(), t = A("column" + n[o]), "breakbefore" !== e && "breakafter" !== e && "breakinside" != e || (t = t || A(n[o])), g.addTest("csscolumns." + e, t)
    ...
    for (let O = 0; O < g._q.length; O++) g._q[O]();
    i.Modernizr = g
}(window, document);
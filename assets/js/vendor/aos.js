! function (e, t) {
    ...
    let  e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
    ...
    function M(e) {
        e && e.forEach(function (e) {
            ...
            if (function e(t) {
                    for (let  o, n = void 0, n = 0; n < t.length; n += 1) {
    ...
    function J(e) {
        for (let  t = 0, o = 0; e && !isNaN(e.offsetLeft) && !isNaN(e.offsetTop);) t += e.offsetLeft - ("BODY" != e.tagName ? e.scrollLeft : 0), o += e.offsetTop - ("BODY" != e.tagName ? e.scrollTop : 0), e = e.offsetParent;
        return {
            top: o,
            left: t
        }
    ...
    function R() {
        let  e = document.querySelectorAll("[data-aos]");
    ...
    function V() {
        ...
        (te = 0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? !0 : te) && (r = oe, (e = ee).forEach(function (e, t) {
            let  o = Q(e.node, "mirror", r.mirror),
            ...
            r.initClassName && e.node.classList.add(r.initClassName), e.position = {
                in: function (e, t, o) {

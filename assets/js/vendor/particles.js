...
let pJS = function (e, t) {
    let a = document.querySelector("#" + e + " > .particles-js-canvas-el");
    this.pJS = {
        canvas: {
            el: a,
            w: a.offsetWidth,
    ...
    t && Object.deepExtend(p, t), p.tmp.obj = {
        ...
        for (let e = 0; e < p.particles.number.value; e++) p.particles.array.push(new p.fn.particle(p.particles.color, p.particles.opacity.value))
    }, p.fn.particlesUpdate = function () {
        for (let e = 0; e < p.particles.array.length; e++) {
            let t, a = p.particles.array[e];
            if (p.particles.move.enable && (t = p.particles.move.speed / 2, a.x += a.vx * t, a.y += a.vy * t), p.particles.opacity.anim.enable && (1 == a.opacity_status ? (a.opacity >= p.particles.opacity.value && (a.opacity_status = !1), a.opacity += a.vo) : (a.opacity <= p.particles.opacity.anim.opacity_min && (a.opacity_status = !0), a.opacity -= a.vo), a.opacity < 0 && (a.opacity = 0)), p.particles.size.anim.enable && (1 == a.size_status ? (a.radius >= p.particles.size.value && (a.size_status = !1), a.radius += a.vs) : (a.radius <= p.particles.size.anim.size_min && (a.size_status = !0), a.radius -= a.vs), a.radius < 0 && (a.radius = 0)), t = "bounce" == p.particles.move.out_mode ? {
                ...
                for (let i = e + 1; i < p.particles.array.length; i++) {
                    let n = p.particles.array[i];
        ...
        for (let e = 0; e < p.particles.array.length; e++) p.particles.array[e].draw()
        ...
        p.tmp.pushing = !0;
        for (let a = 0; a < e; a++) p.particles.array.push(new p.fn.particle(p.particles.color, p.particles.opacity.value, {
        ...
        for (let a = 0; a < p.particles.array.length; a++) {
            let i = p.particles.array[a],
                n = e.x - i.x,
                s = e.y - i.y;
        ...
        for (let o = 0; o < r; o++) e.lineTo(i, 0), e.translate(i, 0), e.rotate(c);
        e.fill(), e.restore()
...
Object.deepExtend = function (e, t) {
    for (let a in t) t[a] && t[a].constructor && t[a].constructor === Object ? (e[a] = e[a] || {}, arguments.callee(e[a], t[a])) : e[a] = t[a];
    return e
...
let Stats = function () {
    ...
    function t(e) {
        for (let t = 0; t < i.children.length; t++) i.children[t].style.display = t === e ? "block" : "none";
        a = e
    }
    let a = 0,
